...
from .misc import frozendict, AltDict, Annotatable, cache_rights, HasAcls, HasDynacls, enforce_63byte_id, truncated_identifier
...
""" % {
    ...
    def _to_column_names(self):
        ...
        return [
            str(self.reference_map[self.foreign_key.table.columns[colname]].name)
...
class PseudoKeyReference (KeyReference):
    ...
    def __init__(self, foreign_key, unique, fk_ref_map, rid=None, constraint_name=("", None), annotations={}, comment=None, acls={}, dynacls={}, reject_duplicates=True):
        super(PseudoKeyReference, self).__init__(foreign_key, unique, fk_ref_map, rid=rid, constraint_name=constraint_name, annotations=annotations, comment=comment, acls=acls, dynacls=dynacls, reject_duplicates=reject_duplicates)
